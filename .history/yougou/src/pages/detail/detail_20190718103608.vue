...
<swiper indicator-dots autoplay  interval="3000" duration="500" class="detaillunbo" indicator-active-color="#fff">
  <block>
    <swiper-item>
      <image src="https://img.alicdn.com/imgextra/i4/725677994/O1CN01IPVd2228vIh7JhyLD_!!725677994.jpg_430x430q90.jpg" />
    </swiper-item>
    <swiper-item>
      <image src="https://img.alicdn.com/imgextra/i4/725677994/O1CN01IPVd2228vIh7JhyLD_!!725677994.jpg_430x430q90.jpg" />
    </swiper-item>
...
<!-- 底部选项 -->
<div class="bottom">
  <div class="start"><i class="iconfont  icon-shoucang"></i>联系客服</div>
  <div class="start"><i class="iconfont  icon-shoucang"></i>购物车</div>
  <div class="end">加入购物车</div>
  <div  class="end">立即购买</div>
  <!-- <div class='service'><i class="iconfont  icon-kefu">联系客服</div>
  <div class="sgopcart"><i class="iconfont  icon-gouwuche">购物车</div>
  <div class="jioncart">加入购物车</div>
