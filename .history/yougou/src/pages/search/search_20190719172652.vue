...
<!-- 头部搜索 -->
  <div class="head-search">
   <input @input="searchthink" @confirm="tosearch" v-model="key" type="search" placeholder="请输入你想要的商品" />
   <div class="thinkbox" v-if="thinkList.length !==0">
     <div class="think"  v-for="(item1,index1) in thinkList" :key="index1">{{item1.goods_name}}</div>
   </div>
